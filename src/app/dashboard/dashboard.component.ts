...
export class DashboardComponent implements OnInit, AfterViewInit {
    ...
    private subject = new BehaviorSubject<TableData>(null);
    public tableData$: Observable<TableData> = this.subject.asObservable();
  ...
  public ngOnInit() {
        ...
        this.reportService.getOrderTotals().pipe(
            map(order => {
                return {
                    headerRow: [],
                    dataRows: order
        ...
        ).subscribe(o => this.subject.next(<TableData>o));
